			...
			<div className="relative -top-3 mx-auto max-w-sm rounded-t-2xl dark:border-t-2 dark:border-main-white bg-main-black sm:flex sm:justify-between sm:items-center sm:max-w-xl sm:mx-0 sm:ml-auto sm:rounded-none sm:rounded-l-2xl sm:dark:border-l-2 sm:dark:border-b-2">
				...
				>
					...
					<span className="flex flex-col">
						<label htmlFor="name" className="text-main-white">
							Name
						</label>
						<input
							id="name"
							name="name"
							type="text"
							className="bg-main-white p-2 font-light outline-none"
							required
						/>
					...
					<span className="flex flex-col">
						<label htmlFor="email" className="text-main-white">
							Email
						</label>
						<input
							id="email"
					...
					<span className="flex flex-col">
						<label htmlFor="message" className="text-main-white">
							Message
						</label>
						<textarea
							id="message"
							name="message"
							className="bg-main-white p-2 font-light outline-none h-28 max-h-28 min-h-[64px]"
					...
					{!state.succeeded && (
						<button className="flex justify-center items-center bg-transparent border-2 border-main-white text-main-white hover:bg-main-white hover:text-main-black">
							Send
						</button>
					)}
					{state.succeeded && (
						<button className="flex justify-center items-center bg-transparent border-2 text-main-white border-[#4BB543] bg-[#4BB543]">
							Thanks!!!
						</button>
					)}
				</form>
