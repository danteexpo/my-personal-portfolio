		...
		<section className="mt-8 max-w-3xl mx-auto">
			<header className="flex flex-col justify-center items-center md:flex-row md:justify-between">
				<button
					...
					className="relative text-center font-bold text-2xl text-main-white py-2 px-4 bg-none border-2 border-main-white cursor-pointer transition duration-500 ease-out hover:bg-main-white hover:text-main-black sm:text-3xl"
				>
					New Game
				</button>
